...
class InterfaceMusica(object):
    ...
    # Método que não chamado para listar as pessoas existentes
    ...
    # Método que não chamado para listar uma existente, filtrando pelo código
    ...
    def menu_inserir_uma_musica(self):
        ...
        duracao = input("Digite a duração da música (xx:xx:xx): ")
        data_criacao = input("Digite a data de criação da música (DD-MM-AAAA): ")
    ...
    def menu_atualizar_uma_musica(self):
        ...
        duracao = input("Digite a nova duração da música (xx:xx:xx): ")
        data_criacao = input("Digite a nova data de criação da música (DD-MM-AAAA): ")
